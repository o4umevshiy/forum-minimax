...
export default new Vuex.Store({
  state: {
    ...
    list : [
      ...
      { index : '25', name : 'Ближний космос', text : 'Где проходят границы солнечной системы? Относительные размеры и особенности Солнца, планет и их спутников. Основные вехи освоения космоса. Как используется космос сейчас? Когда и как будут освоены Луна и Марс? Что дальше?', status : 0 },
